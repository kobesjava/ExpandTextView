...
import kotlinx.android.synthetic.main.text_expand_list_activity.*
import kotlinx.android.synthetic.main.text_expand_list_item_view.view.*

class TextExpandListActivity : AppCompatActivity() {

    val listData: MutableList<String> = mutableListOf()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.text_expand_list_activity)
    ...
    inner class MyAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
            val view = View.inflate(parent.context, R.layout.text_expand_list_item_view, null)
            view.layoutParams = RecyclerView.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT)
            return ViewHolder(view)
        }

        override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
            holder.itemView.txt1.setData(2, listData[position], "展开")
        }
